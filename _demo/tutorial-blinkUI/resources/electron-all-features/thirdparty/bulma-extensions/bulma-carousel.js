...
var Navigation = function () {
	...
	_createClass(Navigation, [{
		...
		value: function _bindEvents() {
			...
			// });
			this.slider.wrapper.addEventListener('click', _this.onNextClick);
			// _this._ui.previous.addEventListener('click', _this.onPreviousClick);
			// _this._ui.next.addEventListener('click', _this.onNextClick);
		}
	}, {
		key: '_unbindEvents',
		value: function _unbindEvents() {
			...
			// });
			// _this2._ui.previous.removeEventListener('click', _this2.onPreviousClick);
			// _this2._ui.next.removeEventListener('click', _this2.onNextClick);
			this.slider.wrapper.removeEventListener('click', _this2.onNextClick);
